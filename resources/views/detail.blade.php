                                ...
                                <div class="col-lg-6 mx-auto">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Detail Pembayaran!</h1>
                                        </div>
                                        <h1 class="h5 text-gray-900 mb-2">Nama</h1>
                                        <h1 class="h6 text-gray-900 mb-2"style="color:grey">Jono Joni Jontor</h1>
                                        <h1 class="h5 text-gray-900 mb-2">Kontak</h1>
                                        <h1 class="h6 text-gray-900 mb-2"style="color:grey">082011633057</h1>
                                        <h1 class="h5 text-gray-900 mb-2">Tipe Layanan</h1>
                                        <h1 class="h6 text-gray-900 mb-2"style="color:grey">Cuci Kering</h1>
                                        <h1 class="h5 text-gray-900 mb-2">Total Berat</h1>
                                        <h1 class="h6 text-gray-900 mb-2"style="color:grey">5 kg</h1>  
                                        <h1 class="h5 text-gray-900 mb-2">Tanggal Pesanan</h1>
                                        <h1 class="h6 text-gray-900 mb-2"style="color:grey">Selasa, 26/04/2022</h1>
                                        <hr>
                                        <div align="right">
                                            <h1 class="h3 text-gray-900 mb-2">TOTAL HARGA</h1> 
                                            <h1 class="h2 text-gray-900 mb-2 P"style="color:grey">Rp. 25000</h1>  
                                        </div>
                                    </div>
                                </div>
                        </div>
